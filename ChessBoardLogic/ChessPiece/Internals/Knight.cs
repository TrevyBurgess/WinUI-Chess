...
namespace TrevyBurgess.Games.TrevyChess.ChessBoardLogic.Internal
{
    ...
    internal class Knight : ChessPiece
    {
        ...
        public override bool CanMove()
        {
            ...
            {
                if (this.CanMove(new ChessPieceLocation((ColPos)(iStartCol - 2), (RowPos)(iStartRow - 1))))
                    return true;
            }
            ...
            {
                if (this.CanMove(new ChessPieceLocation((ColPos)(iStartCol - 1), (RowPos)(iStartRow - 2))))
                    return true;
            }
        ...
        public override IEnumerable<ChessMove> PossibleMoveList()
        {
            ...
            if (iStartCol > 2 && iStartRow > 1)
            {
                ChessMove move = new ChessMove(Location.ColLoc, Location.RowLoc, (ColPos)(iStartCol - 2), (RowPos)(iStartRow - 1));
            ...
            if (iStartCol > 1 && iStartRow > 2)
            {
                ChessMove move = new ChessMove(Location.ColLoc, Location.RowLoc, (ColPos)(iStartCol - 1), (RowPos)(iStartRow - 2));
