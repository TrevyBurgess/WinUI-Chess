...
namespace TrevyBurgess.Games.TrevyChess.ChessBoardLogic.Internal
{
    ...
    internal class PawnWhite : ChessPiece
    {
        ...
        {
            Contract.Assume((((ChessPiece)this).Location.RowLoc != ((RowPos)(2)) || ValidateBounds.IsInBounds(((ChessPiece)this).Location.ColLoc)));
            ...
            {
                ChessMove move = new ChessMove(Location.ColLoc, Location.RowLoc, Location.ColLoc, (RowPos)(iStartRow + 2));
            ...
            {
                ChessMove move = new ChessMove(Location.ColLoc, Location.RowLoc, Location.ColLoc, (RowPos)(iStartRow + 1));
            ...
            {
                ChessMove move = new ChessMove(Location.ColLoc, Location.RowLoc, (ColPos)(iStartCol - 1), (RowPos)(iStartRow + 1));
