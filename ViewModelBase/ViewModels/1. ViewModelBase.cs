...
// </Author>
//------------------------------------------------------------
namespace CyberFeedForward.ViewModelBase.ViewModels;
...
public abstract class ViewModelBase : INotifyPropertyChanged
{
    ...
    {
        if (!propertyStore.TryGetValue(propertyName, out object value))
        {
            value = new RelayCommand(execute, canExecute);
            propertyStore[propertyName] = value;
        }
        ...
        [CallerMemberName] string propertyName = null)
    {
        if (!propertyStore.TryGetValue(propertyName, out object value))
        {
            value = new RelayCommand<TCommandParameter>(execute, canExecute);
            propertyStore[propertyName] = value;
        }

        return (RelayCommand<TCommandParameter>)value;
    }
