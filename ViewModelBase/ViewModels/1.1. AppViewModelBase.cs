...
using CyberFeedForward.ViewModelBase.General;
using CyberFeedForward.ViewModelBase.Models;
using System;
...
/// </summary>
public abstract class AppViewModelBase<TAppViewModel> :
    ViewModelBase
    where TAppViewModel : AppViewModelBase<TAppViewModel>
{
    #region Search
