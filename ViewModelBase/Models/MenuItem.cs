...
public class MenuItem<TAppViewModel> where TAppViewModel : AppViewModelBase<TAppViewModel>
{
    /// <summary>
    ...
    public MenuItem(
        ...
        bool reentry = false)
    {
        MenuTitle = menuTitle ?? (viewModel?.PageTitle);
        MenuIcon = menuIcon ?? (viewModel?.IconCode);
        Page = page;
        ViewModel = viewModel;
        UseBackButton = false;
        IsCommand = false;
